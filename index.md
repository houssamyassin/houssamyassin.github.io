...
*The above video shows the vorticity (a measure of spin) from a simulation of two-dimensional turbulence using the python [pyqg pseudo-spectral model](https://github.com/pyqg/pyqg). Red is positive vorticity (counterclockwise spin) whereas blue is negative vorticity (clockwise spin).*
